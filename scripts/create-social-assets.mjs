...
// Usa exatamente o S da logomarca (primeiro path), com respiro em tela quadrada.
const initial = logo.match(/<path\b[^>]*\/>/)[0];
const icon = `<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><rect width="64" height="64" rx="14" fill="#f0ff27"/><g transform="translate(12 5) scale(1.1)">${initial}</g></svg>`;
