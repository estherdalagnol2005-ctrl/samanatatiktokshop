    ...
    section.innerHTML = `
      <div class="about-samanta-shell">
        ...
        <div class="about-samanta-copy">
          ...
          <p>Vim de uma família simples do Rio Grande do Sul e comecei a trabalhar ainda muito nova, com <strong>12 anos</strong>. Já trabalhei em fábrica de calçados, loja de shopping e vivi por muito tempo a rotina da <strong>CLT</strong>. No meu último emprego, trabalhava todos os dias da semana e passava cerca de duas horas no ônibus para ir e outras duas para voltar para casa. Aos <strong>20 anos</strong>, saí do Rio Grande do Sul e vim para Santa Catarina querendo mudar minha realidade. Naquela época, eu não imaginava que poderia encontrar algo que eu realmente gostasse de fazer no digital.</p>
